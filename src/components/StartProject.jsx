...
function StartProject() {
  ...
  return (
    <div className='w-full md:h-screen h-[80vh] md:mt-0 mt-[10vh]  pt-20 relative'>
        <h1 className='text-white font-[FG] font-extrabold md:text-[12.5vw] text-[22vw] uppercase md:leading-[10vw] leading-[16vw] text-center tracking-tight'>Ready</h1>
        <h1 className='text-white font-[FG] font-extrabold md:text-[12.5vw] text-[22vw] uppercase md:leading-[10vw] leading-[16vw] text-center tracking-tight'>to start</h1>
        <h1 className='text-white font-[FG] font-extrabold md:text-[12.5vw] text-[22vw] uppercase md:leading-[10vw] leading-[16vw] text-center tracking-tight'>the project?</h1>
