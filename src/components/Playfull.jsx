...
function Playfull() {
  ...
  const elements = Array.from({ length: 2 }).map((_, i) => (
    <div key={i} className='md:size-[14vw] size-[40vw] bg-white rounded-full grid items-center justify-center'>
      <div className='md:size-[8.5vw] size-[23vw] bg-blue-950 relative rounded-full flex items-center justify-center'>
        <span className='text-white font-medium md:text-[1.5vw] text-[4vw]'>ORBIT</span>
        <div
          style={{
