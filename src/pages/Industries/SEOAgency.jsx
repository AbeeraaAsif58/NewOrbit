    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Data Analytics • SEO • Process Automation
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Transform Your Business with <span className="text-cyan-200">Cutting-Edge Analytics Solutions</span>
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          We develop bespoke analytics solutions focused on your target audience's needs. Own your data and add new features as necessary with our innovative approach.
        </p>
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "300%", l: "Data Insights" },
            { k: "99%", l: "Accuracy Rate" },
            { k: "4x", l: "Process Efficiency" },
            { k: "24/7", l: "Analytics Support" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["Data Analytics", "Process Automation", "Financial Data", "Executive Dashboards", "Data Visualization", "Business Intelligence"];
  return (
...
function FeaturedSection() {
  const cards = [
    ...
    },
    {
      ...
      desc: "Employ deep automation in key business processes vulnerable to data entry and validation errors.",
      tech: ["Automation", "Data Validation", "Process Optimization"],
    },
    {
      tag: "Popular",
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    title: [
      "Roots Wall Analytics",
      "CashCare Data Management",
      "Gamiverz Process Automation",
    ...
    desc:
      [
        "Advanced analytics platform for global money transfer with real-time data processing and visualization.",
        "Comprehensive data management system for financial services with mortgage and investment analytics.",
        "Automated gaming community platform with data-driven insights and transaction analytics.",
        "Secure financial tools data visualization with cybersecurity and compliance monitoring.",
        "Modern banking analytics dashboard with lending, borrowing, and investment data insights.",
        "Blockchain solution data analysis platform for innovative financial technology applications.",
        "Financial data integration system connecting multiple data sources and third-party services.",
        "API-driven data processing solution for financial platforms and automated business processes.",
        "Comprehensive business intelligence system for financial operations and compliance reporting.",
      ][i],
  }));
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "UFG LAB's data analytics solution increased our insights by{" "}
          <span className="text-cyan-200">300%</span> and process efficiency by 4x. The automation delivered exactly what we needed."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— Data Manager, Financial Services Inc.</div>
      </div>
    </section>
  );
}
      ...
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          ...
          <p className="mt-2 max-w-xl text-white/80">
            Let's work together to bring your vision to life. Our team of experts is ready to help you create something extraordinary with cutting-edge analytics solutions.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">SEO Dashboard</div>
          </div>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-5 transition hover:-translate-y-1.5 hover:border-cyan-200/50">
      <div className="aspect-video w-full overflow-hidden rounded-xl border border-white/10 bg-white/5">
        <div className="flex h-full items-center justify-center text-white/40">SEO Results</div>
      </div>
      <h3 className="mt-3 text-lg font-semibold transition-colors group-hover:text-cyan-200">{title}</h3>
