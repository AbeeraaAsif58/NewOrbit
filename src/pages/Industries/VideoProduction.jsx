    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Video Solutions • Motion Graphics • Process Automation
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Transform Your Business with <span className="text-cyan-200">Cutting-Edge Video Solutions</span>
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          We develop bespoke video solutions focused on your target audience's needs. Own your content and add new features as necessary with our innovative approach.
        </p>
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "200+", l: "Video Solutions" },
            { k: "99%", l: "Client Satisfaction" },
            { k: "5x", l: "Engagement Boost" },
            { k: "24/7", l: "Video Support" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["Adobe Premiere", "After Effects", "DaVinci Resolve", "Final Cut Pro", "Cinema 4D", "Blender"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "High-impact commercials and promotional videos that drive brand awareness and sales.",
      tech: ["Commercial", "Brand Video", "Promotional"],
    },
    {
      tag: "New",
      title: "Explainer Video Series",
      desc: "Clear, engaging explainer videos that simplify complex concepts and products.",
      tech: ["Explainer", "Educational", "Animated"],
    },
    {
      tag: "Popular",
      title: "Corporate Video Content",
      desc: "Professional corporate videos for training, presentations, and internal communications.",
      tech: ["Corporate", "Training", "Internal"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    title: [
      ...
      "Restaurant Brand Video",
      "SaaS Product Demo",
      "Healthcare Training Video",
      "Fashion Brand Campaign",
      "Real Estate Virtual Tour",
      "Non-profit Story Video",
      "Corporate Training Series",
      "E-commerce Product Video",
    ][i],
    desc:
      [
        "Dynamic commercial showcasing a fintech app's features and benefits to target audience.",
        "Cinematic brand video capturing the essence of a farm-to-table restaurant experience.",
        "Clear product demo video explaining complex SaaS features in simple terms.",
        "Professional training video for healthcare staff on new procedures and protocols.",
        "Stylish fashion campaign video highlighting brand values and product quality.",
        "Immersive virtual tour video showcasing luxury real estate properties.",
        "Emotional story video highlighting the impact of a non-profit organization's work.",
        "Comprehensive training series for corporate employees on new systems and processes.",
        "Engaging product videos showcasing e-commerce items with detailed features.",
      ][i],
  }));
  ...
  return (
    <section id="projects" className="mt-12" data-reveal>
      <div className="mb-4 flex items-end justify-between">
        <h2 className="text-xl font-semibold sm:text-2xl">Video portfolio</h2>
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "The video they produced for our product launch generated{" "}
          <span className="text-cyan-200">300% more engagement</span> than our previous campaigns. Absolutely stunning work."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— Marketing Director, TechFlow Inc.</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to create your next video?</h3>
          <p className="mt-2 max-w-xl text-white/80">
            Let's bring your vision to life with professional video production that captivates your audience and drives results.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Video Preview</div>
          </div>
