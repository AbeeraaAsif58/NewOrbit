    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Performance Marketing • Growth Ops • Analytics
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Drive measurable growth, <span className="text-cyan-200">scale your business</span> — performance marketing
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          Data-driven marketing strategies that deliver measurable results and sustainable growth for your business.
        </p>

        <div className="mt-7 grid gap-3 sm:max-w-2xl sm:grid-cols-[1fr_auto]">
          <div className="relative">
            <input
              placeholder="Search: PPC, social media, email marketing, analytics…"
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "300%", l: "ROI Increase" },
            { k: "95%", l: "Client Retention" },
            { k: "2.5x", l: "Lead Generation" },
            { k: "24/7", l: "Campaign Monitoring" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["Google Ads", "Facebook", "LinkedIn", "HubSpot", "Mailchimp", "Analytics"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "High-converting PPC campaigns across Google, Facebook, and LinkedIn that maximize ROI.",
      tech: ["Google Ads", "Facebook Ads", "LinkedIn Ads"],
    },
    {
      tag: "New",
      title: "Email Marketing Automation",
      desc: "Automated email sequences that nurture leads and drive conversions throughout the customer journey.",
      tech: ["Email Automation", "Lead Nurturing", "Segmentation"],
    },
    {
      tag: "Popular",
      title: "Social Media Management",
      desc: "Strategic social media management that builds brand awareness and engages your target audience.",
      tech: ["Social Strategy", "Content Creation", "Community Management"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        "Generated 500+ qualified leads for a SaaS startup through targeted PPC and content marketing.",
        "Increased e-commerce sales by 250% through optimized Google Shopping and search campaigns.",
        "Built a strong B2B presence on LinkedIn with thought leadership and lead generation campaigns.",
        "Improved patient engagement by 300% through personalized email marketing automation.",
        "Boosted real estate agent visibility and lead generation through strategic social media management.",
        "Scaled a tech startup from 0 to 10K users through comprehensive growth marketing strategy.",
        "Increased local restaurant foot traffic by 150% through location-based marketing campaigns.",
        "Generated high-quality leads for financial services through targeted PPC and landing page optimization.",
        "Expanded non-profit reach and donations by 200% through digital marketing and social media strategy.",
      ][i],
  }));
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "Our marketing ROI increased by{" "}
          <span className="text-cyan-200">400%</span> in just 6 months. The data-driven approach delivered exactly what we needed."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— Marketing Director, GrowthCo</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to scale your marketing?</h3>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Marketing Dashboard</div>
          </div>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-5 transition hover:-translate-y-1.5 hover:border-cyan-200/50">
      <div className="aspect-video w-full overflow-hidden rounded-xl border border-white/10 bg-white/5">
        <div className="flex h-full items-center justify-center text-white/40">Campaign Results</div>
      </div>
      <h3 className="mt-3 text-lg font-semibold transition-colors group-hover:text-cyan-200">{title}</h3>
