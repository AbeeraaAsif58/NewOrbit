...
const ProjectDetail = () => {
  ...
  const projects = {
    ...
    'close-sourcing-b2b-ecommerce-bulk-discount': {
      ...
      description: "The complete solution for running a wholesale, B2B, hybrid B2B+B2C, or private Membership store. We take care of everything, from basic aspects such as hiding prices for guest users, to advanced bulk discount management and B2B user authentication.",
      ...
      features: [
        ...
        "B2B user authentication and verification",

        "Bulk discount management system",

        "Wholesale pricing tiers",

        "Private membership store functionality",

        "Hybrid B2B+B2C marketplace support",
      ...
      demoUrl: "https://demo.closesourcing.com",
