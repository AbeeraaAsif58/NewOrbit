...
const ProjectDetail = () => {
  ...
  const projects = {
    ...
    'parkingrabbit-daily': {
      ...
      category: "Automobile",
      tags: ["ERP & CRM", "SaaS", "Parking Management", "Laravel"],
      ...
      features: [
        ...
        "Parking Category Management",
        "Create parking category (car, bike, bus, pickup, etc.)",
        "Edit parking category options",
        "Floor Setup Management",
        "Add parking floor based on needs (Basement-1, Basement-2, etc.)",
        "Setup floor level configuration",
        "Dynamic Tariff Management",
        "Add dynamic tariff rate based on date range and vehicle category",
        "Set minimum 1st hour parking charge and after 1st hour rates",
        "Manage parking charge by date & vehicle category wise",
        "Free parking setup by setting 0 in charges",
        "Parking Setup Management",
        "Add unlimited parking slots under Floor and vehicle category",
        "Customize parking slot configuration",
        "Parking Management Features",
        "Parking In/Out by scanning barcode",
        "Show available and booked parking slots",
        "Show available and booked slots based on vehicles & floor wise",
        "All parking list management",
        "End parking list tracking",
        "Currently parked vehicles list",
        "Comprehensive Reports",
        "Date wise parking list",
        "Date wise received amount from parking",
        "Date, vehicle, vehicle no & driver name wise parking report",
        "General Settings",
        "Modify site name",
        "Change Login background Image, Logo and Favicon",
        "App TimeZone Setting",
        "App Datetime Format Setting",
        "Database Datetime Format Setting",
        "Multi-language Support",
      ...
      demoUrl: "https://www.ufglab.com/industries/automobile/parkingrabbit-daily",
      githubUrl: "https://github.com/ufglab",
    ...
    'practova-appointment-booking-with-time-slot-app-practo-clone': {
      title: "Practova – Appointment Booking With Time-slot app – Practo clone",
      category: "Directory",
      tags: ["Directory", "Healthcare", "Mobile Apps", "Appointment Booking"],
      ...
      features: [
        ...
        "Check upcoming appointments on first page",
        "Search bar to search Doctor",
        "Speciality wise sorting of doctors",
        "Complete Doctor Profile Management",
        "Doctor name and speciality display",
        ...
        "Time-slot wise appointment booking",
        "Choose convenient time-slot for appointment",
        "Time-slot booking prevents double booking",
        "Book appointment description to explain problem to doctor",
        ...
        "Manage profile, add and edit profile details",
        "Payment Gateway Integration",
        "Cash on delivery option",
        "Braintree or PayPal integration",
        "Stripe payment (Debit or credit card)",
        "Doctor Working Time-slot Management",
        ...
        "Doctor gets notification when new appointment is booked",
        "User gets notification when doctor accepts appointment",
        "User gets notification if doctor rejects appointment",
        "User gets notification when absent for appointment",
        "User gets notification if admin sends notification",
        "User gets notification when doctor sets appointment as complete",
        "Language Translation Support",
        "RTL & Arabic support",
        "Admin Panel Features",
        "Admin Dashboard with key metrics",
        "Check list of latest appointments",
        ...
        "All doctors list register in system",
        "App Patient List management",
        "Delete spam User functionality",
        "Add edit & delete speciality",
        "Check Reviews added by user",
        "Get user complaints on board",
      ...
      technologies: [
        "PHP", "Laravel", "MySQL", "Flutter", "Java", "Android", "iOS",
        "JavaScript", "HTML5", "CSS3", "Bootstrap", "jQuery",
        "RESTful API", "Cloud Linux", "Unlimited Hosting Space"
      ],
      demoUrl: "https://www.ufglab.com/industries/directory/practova-appointment-booking-with-time-slot-app-practo-clone",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },

    'couponlife-affiliate-submitting-coupons-application': {
      title: "CouponLife – Affiliate & Submitting Coupons Application",
      category: "Directory",
      tags: ["Directory", "eCommerce", "Coupon Management"],
      ...
      features: [
        ...
        "Complete affiliate application for coupons",
        "Import coupons from files or affiliate network",
        "Drag & drop functionality for easy import",
        "XML/CSV file import support",
        "Front End Coupon Submit",
        "Allow users to submit their coupons",
        "Review system before publishing",
        "Complete control over coupon content",
        "User interaction enhancement",
        "Coupon Types Management",
        "Coupon Code (online code for checkout)",
        "Online Sale (leads to sale page)",
        "In Store Coupon (printable coupon)",
        "Multiple coupon format support",
        "Coupon Timing Features",
        "Forever lasting coupons support",
        "Limited time coupons support",
        "Expire dates display",
        "Count down clocks for visitors",
        "Sort coupons by expire time",
        "Smart Search System",
        "Display only active coupons in search",
        "Remember listing type for each user",
        "Remember sorting order for each user",
        "Apply saved preferences on every search",
        "Personalized search experience",
        "Successful Level Tracking",
        "Coupon success feedback collection",
        "Visitor feedback on coupon effectiveness",
        "Graphical success representation",
        ...
        "Store coupons for later usage",
        "Track used and unused coupons",
        ...
        "No password/username memorization",
        "Seamless social authentication",
        "Speed Optimization",
        "Hooks into existing queries",
        "Fastest possible searching",
        "Fastest possible listing",
        "Optimized database performance",
        "Minimal query stress",
        "SEO Optimization",
        "Latest SEO standards implementation",
        "Search engine ranking optimization",
        "SEO-friendly URL structure",
        "Meta tags optimization",
        "Schema markup support",
        "Translate Ready Features",
        "Easy translation using poEdit program",
        "POT file from language folder",
      ...
      demoUrl: "https://www.ufglab.com/industries/directory/couponlife-affiliate-submitting-coupons-application",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'bunnpay-complete-ecommerce': {
      title: "Bunnpay – Complete eCommerce Platform",
      category: "eCommerce",
      tags: ["eCommerce", "Payment", "WordPress", "CMS"],
      ...
      technologies: [
        "PHP", "WordPress", "MySQL", "JavaScript", "HTML5", "CSS3",
        "Bootstrap", "jQuery", "RESTful API", "Cloud Linux", "Unlimited Hosting Space"
      ],
      demoUrl: "https://www.ufglab.com/industries/ecommerce/bunnpay-complete-ecommerce",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'nexagram-instagram-clone-image-photo-sharing-social-network-platform': {
      ...
      tags: ["Entertainment", "Social", "Instagram Clone", "Photo Sharing"],
      ...
      image: "https://www.ufglab.com/projects/instagram-clone-350x197.jpg",
      heroImage: "https://www.ufglab.com/projects/instagram-clone-350x197.jpg",
      overview: "Nexagram is the best Instagram clone website and application, providing the perfect solution to start your own photo-sharing platform. Built with high performance and capability, it can handle any amount of videos and images easily while maintaining excellent speed and user experience. The platform includes all essential Instagram features with modern UI design and powerful admin panel for complete control.",
      features: [
        "Upload Images & Videos",
        "Upload any image or video from device",
        "Share content online instantly",
        "High Performance & Capability",
        "Handle any amount of videos/images easily",
        "Very high performance and speed",
        "Optimized for large-scale content",
        "Facebook Clone Integration",
        "One-click login using Facebook Clone Social Network",
        "Seamless social media integration",
        "Social authentication system",
        "Like System",
        "User can like videos or images",
        "Like counter and tracking",
        "Interactive engagement features",
        "Comments System",
        "User can comment on videos and images",
        "Real-time comment updates",
        "Comment moderation tools",
        "FFMPEG Integration",
        "Limit video upload duration using FFMPEG",
        ...
        "SEO Friendly",
        "SEO friendly links",
        "HTML code that Google will love",
      ...
      technologies: [
        "PHP", "MySQL", "Yii Framework", "Native Java", "Android",
        "JavaScript", "HTML5", "CSS3", "Bootstrap", "jQuery",
        "FFMPEG", "RESTful API", "Cloud Linux", "Unlimited Hosting Space"
      ],
      demoUrl: "https://www.ufglab.com/industries/entertainment/nexagram-instagram-clone-image-photo-sharing-social-network-platform",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'fantasy-aviator-real-money-aviator-game': {
      title: "Aviator – Real Money Aviator Game",
      category: "Fantasy",
      tags: ["Fantasy", "Games", "Real Money", "Casino"],
      description: "Aviator is not just a game; it's an experience. This unique game combines elements of risk and reward, offering players an immersive journey. Features multiplier levels, risk management, bonus rounds, interactive gameplay, tournaments, community engagement, and seamless desktop and mobile experience.",
      ...
      heroImage: "https://ufg-lab-roan.vercel.app/projects/aviator-banner-350x175.png",
      overview: "Aviator is a unique aviation-themed casino game that combines elements of risk and reward for an exhilarating gaming experience. Players embark on a journey where multiplier levels, risk management, and bonus rounds play a crucial role in determining their success.",
      features: [
        "Multiplier Levels: Unique system of multiplier levels that increase as you progress",
        "Risk and Reward: Core philosophy revolving around risk and reward mechanics",
      ...
      demoUrl: "https://www.ufglab.com/industries/fantasy/fantasy-aviator-real-money-aviator-game",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },

    'fantasy-color-iq-real-money-colour-prediction-game': {
      title: "Color IQ – Real Money Colour Prediction Game",
      category: "Fantasy",
      tags: ["Fantasy", "Games", "Prediction", "Real Money"],
      description: "Color game is an exciting and popular predicting game that has been gaining traction. Players have three minutes to correctly predict the color of a given image, with successful prediction leading to victory. Features admin panel, user management, betting records, deposit/withdrawal management, referral system, and wallet management.",
      ...
      heroImage: "https://ufg-lab-roan.vercel.app/projects/coloriq-banner-350x233.png",
      overview: "Color IQ is an exciting and popular predicting game that has been gaining traction in the gaming community. Players have three minutes to correctly predict the color of a given image, with successful prediction leading to victory. The game features a comprehensive admin panel, user management, betting records, deposit/withdrawal management, referral system, and wallet management.",
      features: [
        "Color Prediction Game: Exciting three-minute color prediction gameplay",
        "Real Money Rewards: Win real money with successful predictions",
        "Admin Panel: Comprehensive admin panel for game management",
        "User Management: Complete user management system",
        "Betting Records: Track all betting activities and history",
        "Deposit/Withdrawal Management: Secure financial transactions",
        "Referral System: Multi-level referral system for user growth",
        "Wallet Management: Integrated wallet system for funds",
        "Real-time Updates: Live game updates and instant results",
        "Mobile Responsive: Optimized for mobile and desktop devices",
        "Security Features: Secure gaming environment with encrypted transactions",
        "Payment Integration: Multiple payment methods for deposits and withdrawals",
        "User Analytics: Track user performance and statistics",
        "Social Features: Share achievements and compete with friends",
        "Tournament System: Participate in color prediction tournaments",
      ...
      demoUrl: "https://www.ufglab.com/industries/fantasy/fantasy-color-iq-real-money-colour-prediction-game",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },

    'fantasy-byte-lottery-live-online-lottery-application-with-mlm': {
      title: "Byte Lottery – Live Online Lottery Application with MLM",
      category: "Fantasy",
      tags: ["Fantasy", "Games", "Lottery", "MLM"],
      description: "A Lottery Platform that will take your excitement to the next level! Features dynamic lottery system, auto phase creation, multi-level referral system, user-friendly interface, responsive design, two-factor authentication, lottery management, report manager, and comprehensive admin features.",
      ...
      heroImage: "https://ufg-lab-roan.vercel.app/projects/lottery2-banner-350x196.webp",
      overview: "Byte Lottery is a comprehensive lottery platform that will take your excitement to the next level! It features a dynamic lottery system, auto phase creation, multi-level referral system, user-friendly interface, responsive design, two-factor authentication, lottery management, report manager, and comprehensive admin features.",
      features: [
        "Dynamic Lottery System: Flexible lottery system with customizable rules",
        "Auto Phase Creation: Automatic lottery phase creation and management",
        "Multi-level Referral System: Comprehensive MLM referral system",
        "User-friendly Interface: Intuitive and easy-to-use interface",
        "Responsive Design: Optimized for all devices and screen sizes",
        "Two-factor Authentication: Enhanced security with 2FA",
        "Lottery Management: Complete lottery management system",
        "Report Manager: Comprehensive reporting and analytics",
        "Admin Features: Full admin panel with all necessary controls",
        "Real-time Updates: Live lottery updates and results",
        "Payment Integration: Multiple payment methods for tickets and prizes",
        "Prize Distribution: Automated prize distribution system",
        "User Management: Complete user account management",
        "Security Features: Secure platform with encrypted transactions",
      ...
      demoUrl: "https://www.ufglab.com/industries/fantasy/fantasy-byte-lottery-live-online-lottery-application-with-mlm",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },

    'fantasy-lottery-whale-live-lottery-betting-application': {
      title: "Lottery Whale – Live Lottery Betting Application",
      category: "Fantasy",
      tags: ["Fantasy", "Games", "Lottery", "Betting"],
      description: "Live Lottery platform that enables a great opportunity to start your own lottery website. Features premium design, responsive & cross-browser compatibility, automatic & manual payment gateway, referral bonus with level system, full dynamic lottery system, easy documentation, GDPR policy, and comprehensive user and admin features.",
      ...
      heroImage: "https://ufg-lab-roan.vercel.app/projects/lottery-banner-350x197.jpg",
      overview: "Lottery Whale is a live lottery platform that enables a great opportunity to start your own lottery website. It features premium design, responsive & cross-browser compatibility, automatic & manual payment gateway, referral bonus with level system, full dynamic lottery system, easy documentation, GDPR policy, and comprehensive user and admin features.",
      features: [
        "Premium Design: Modern and attractive design interface",
        "Responsive Design: Cross-browser and device compatibility",
        "Payment Gateway: Automatic and manual payment processing",
        "Referral System: Multi-level referral bonus system",
        "Dynamic Lottery System: Full-featured lottery management",
        "Easy Documentation: Comprehensive documentation and guides",
        "GDPR Policy: Full GDPR compliance and data protection",
        "User Features: Complete user account and profile management",
        "Admin Features: Comprehensive admin panel with all controls",
        "Real-time Updates: Live lottery updates and results",
        "Security Features: Secure platform with encrypted transactions",
        "Mobile App: Native mobile applications for iOS and Android",
        "Analytics: Comprehensive analytics and reporting",
      ...
      demoUrl: "https://www.ufglab.com/industries/fantasy/fantasy-lottery-whale-live-lottery-betting-application",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'aviator-real-money-aviator-game': {
      ...
      heroImage: "https://www.ufglab.com/projects/aviator-banner-350x175.png",
    ...
    'color-iq-real-money-colour-prediction-game': {
      ...
      heroImage: "https://www.ufglab.com/projects/coloriq-banner-350x233.png",
    ...
    'lilplates-restaurant-food-delivery-system-with-admin-panel-delivery-man-app-restaurant-pos': {
      title: "Lilplates – Restaurant Food Delivery System with Admin Panel & Delivery Man App | Restaurant POS",
      category: "Restaurant",
      tags: ["eCommerce", "Restaurant", "Food Delivery", "POS System"],
      ...
      features: [
        ...
        "Home page with location setting",
        "Location access permission",
        "Variant types of food display",
        "Offer and promotion display",
        "Veg and non-veg food categories",
        "User login with email and password",
        "User signup with information",
        "Filter products by category",
        "List and grid view options",
        "Product variation selection",
        "Product extras and addons",
        ...
        "Menu-wise item search",
        "Category-based filtering",
        "Veg/Non-veg item search",
        "Newsletter subscription",
        "Footer section",
        "Menu Page Features",
        "Menu-wise item search",
        "Grid and list view options",
        "Variation Page Features",
        "Show single and multi-variation",
        "Add to cart functionality",
        "Cart Page Features",
        ...
        "Coupon system",
        "My Orders Features",
        "Active and previous order list",
        ...
        "Bug fixes and updates",
        "Multi-Branch Support",
        "Single and multi-branch restaurants",
        "Branch management",
      ...
      technologies: [
        "PHP", "MySQL", "CodeIgniter", "Java", "Native Android",
        "Laravel Framework", "Vue.js", "JavaScript", "HTML5", "CSS3",
        "Bootstrap", "jQuery", "RESTful API", "Cloud Linux", "Unlimited Hosting Space"
      ],
      demoUrl: "https://www.ufglab.com/industries/restaurant/lilplates-restaurant-food-delivery-system-with-admin-panel-delivery-man-app-restaurant-pos",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'dixiedaily-dunzo-clone-multivendor-food-grocery-ecommerce-parcel-pharmacy-delivery-website-3-mobile-apps-customer-store-driver-apps': {
      ...
      heroImage: "https://www.ufglab.com/projects/dunzo-clone-350x184.jpg",
      overview: "DixieDaily is a complete Multi-vendor Food, Grocery, eCommerce, Parcel, Pharmacy, or any kind of products delivery system developed using Laravel and Flutter Framework. It comprises 3 Mobile Applications, 2 Web Panels, and 1 website. The powerful admin panel will help you control your business smartly with comprehensive features for multi-vendor management, order processing, and delivery coordination.",
      features: [
        "Complete Multi-vendor System",
        "Food, Grocery, eCommerce delivery",
        "Parcel and Pharmacy delivery",
        "Any kind of products delivery",
        "Laravel and Flutter Framework",
        "Powerful admin panel",
        "Smart business control",
        "Application Components",
        "Customer application for Android, iOS, and web",
        "Delivery Boy application for Android",
        "Store application for both Android and iOS",
        "Super Admin web panel",
        "Store web panel",
        "Order Flow Management",
        "Customer places order from store",
        "Single store order limitation",
        "Delivery boys get order requests",
        "Order acceptance system",
        "Delivery confirmation model",
        "Store order processing",
        "Digital payment integration",
        "Store confirmation model",
        "Order pickup and delivery",
        "Self-pickup order management",
        "Schedule order processing",
        "Top Features",
        "Draw Accurate Coverage Area",
        "Manage multiple zones on map",
        "Map drawing tool for coverage",
        "Store assignment to zones",
        "Coverage-based ordering",
        "System Modules",
        "All types of delivery support",
        "Categorized system modules",
        "Multiple Stores Support",
        "Multi-vendor supported system",
        "Unlimited number of stores",
        "Easy store management",
        "Admin panel store control",
        "SMS OTP Integration",
        ...
        "Units management",
        "Store item assignment",
        "Store panel item management",
        "Advanced Order Management",
        "Efficient order processing",
        "Admin order management",
        "Store manager order control",
        "Dispatch Management",
        "Identify ongoing orders",
        "Track waiting orders",
        "Delivery man assignment",
        "Delivery Men Apps",
        "Unlimited delivery men creation",
        "Order acceptance system",
        "Order delivery tracking",
        "Earning management",
        "Freelancer delivery option",
        "Salaried delivery option",
        "Manual Assign Delivery Man",
        "Direct delivery man assignment",
        "Available delivery man selection",
        "Order assignment control",
        "Marketing Section",
        "Rich admin panel marketing tools",
        "Campaign management",
        "Banner management",
        "Coupon system",
        "Push notifications",
      ...
      technologies: [
        "PHP", "MySQL", "CodeIgniter", "Native Java", "Android",
        "Laravel Framework", "Flutter", "JavaScript", "HTML5", "CSS3",
        "Bootstrap", "jQuery", "RESTful API", "Cloud Linux", "Unlimited Hosting Space"
      ],
      demoUrl: "https://www.ufglab.com/industries/restaurant/dixiedaily-dunzo-clone-multivendor-food-grocery-ecommerce-parcel-pharmacy-delivery-website-3-mobile-apps-customer-store-driver-apps",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'sonicvox-text-to-speech-as-saas-machine-learning-deep-learning': {
      title: "SonicVox – Text to Speech as SaaS (Machine learning, Deep learning)",
      category: "Tools and Utilities",
      tags: ["Text to Speech", "AI", "SaaS", "Machine Learning"],
      description: "Create your own business which allows to turn any text into lifelike speech, allowing you to create various media content such as audio books, podcasts, voice contents and also applications that talk.",
      status: "Available",
      slug: "sonicvox-text-to-speech-as-saas-machine-learning-deep-learning",
      image: "https://ufg-lab-roan.vercel.app/projects/tts-350x189.jpeg",
      heroImage: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=1200&h=600&fit=crop&crop=center",
      overview: "SonicVox is a powerful Text-to-Speech SaaS platform that leverages machine learning and deep learning technologies to convert any text into lifelike speech. This comprehensive solution allows you to create various media content such as audiobooks, podcasts, voice content, and applications that talk, providing a complete business solution for voice generation needs.",
      features: [
      ...
      technologies: [
        ...
        "Neural Networks", "Natural Language Processing", "Audio Processing",
        "Cloud Computing", "RESTful API", "Docker", "Kubernetes", "AWS"
      ],
      demoUrl: "https://www.ufglab.com/industries/tools-and-utilities/sonicvox-text-to-speech-as-saas-machine-learning-deep-learning",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'for-sale-innovative-fintech-banking-company-spain': {
      title: "For Sale: Innovative fintech banking company in Spain",
      category: "Companies",
      tags: ["Fintech", "Banking", "Spain", "For Sale", "EUR 50M"],
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "Our business is an innovative fintech banking company that is registered in Barcelona, Spain. We have our headquarters in Madrid and virtual offices in Barcelona, Estonia, and Bulgaria. We aim to bridge traditional money with digital currencies and provide our customers with a fully regulated banking experience that includes money transfer and payment gateway.",
      features: [
        "Euro Wallet",
        "International and National money transfer",
        "Mastercard",
        "Crypto Wallet",
        "Currency Exchange",
        "Interest-based Crypto Deposits",
        "Merchant Payment Gateway Solutions",
        "Valid license from the UK Electronic Money Institution",
        "Commission-based revenue model",
        "300% growth rate potential with right financing",
        "Amazing technology experts team",
        "Seasoned founding managerial team",
        "Decades of experience in finance, marketing, risk management, and cybersecurity",
        "Furniture, computers, laptops, website ownership",
        "Required permits to operate business",
        "Well-supported business opportunity",
        "Substantial serviceable market",
      ...
      demoUrl: "https://ufglab.com",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://ufglab.com"
    },

    'website-apps-marketplace-100-live-solutions-heloix-clone': {
      title: "Website and Apps Marketplace with 100+ Live Solutions – Heloix Clone",
      category: "Companies",
      tags: ["Marketplace", "Digital Assets", "CRM Solutions", "Web Apps", "Mobile Apps"],
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "This is an online marketplace that facilitates buying of digital assets and businesses. We provide verified and tested CRM solutions, web and mobile applications that enable entrepreneurs to start with a step ahead. Here is the list of solutions available: All Film DB, All Healed, Bankovia, Bhity, Bighitter, Business Brawn, Business Notion, Buyyu, Carous, Chat Central, City Flicker, Delivery Dart, Doctist, Doctor Cave, Doctor Corps, DoxHarbor, ExtraAcre, Food Desk, Foodinga, Friendshiply, Future Shaadi, FuzeTube, Garagify, Gift and Ship, Giga Kart, Gigabrick, Grocer Box, Grocery Space, Grocery West, GymCuts, Happy Jobs, Healthy Web, Hello Hiring, Hey Pharm, Hospitalcore, Hospiva, Hosspital, Hostelstead, HPL, HR Logics, Inboxer, Janoo, Jewellery King, Jiffy Meet, Joboro, Jobs Heaven, Juqe, Juvola, Lawyerify, LeanCRM, Letster, Library Bee, Libraxo, Loan Counter, Ludo HG, Magic Meds, Magzia, Meat Ala, Motion Flix, News Shelf, Nyqaa, Phroma, Pokoki, Posova, Pozlo, Print Perfect, Pru, Quotora, Qwestions, Recruitpool, Recruitrabbit, Result Wizard, Resumesy, Rishtey, Ristly, SALON, Scholarr, SchoolNerd, Schoolowl, SchoolRoster, SchoolSector, Schoolsilo, SecretBus, Skill Buzz, SkillMarks, SupportorBit, Synira, Textzo, Tokito, Tourio, TrueClient, Tunato, Ultreno, Urban Company, Viziweb, WorkYouWant, Xoti, Yellow Leather, YUBR, Zecuna, Zyial",
      features: [
        "100+ Live Solutions Available",
        "All Film DB – Ultimate Movie & Web Series Database",
        "All Healed – Diagnostic Management System",
        "Bankovia – Online Banking With DPS & Loan",
        "Bhity – Inventory Management System with POS, HRM, Accounting",
        "Bighitter – Wallet & Online Banking Online Investment Platform",
        "Business Brawn – Complete SAAS Business Management",
        "Business Notion – Complete SAAS Business for Stock Management, POS & Invoicing",
        "Buyyu: Fashion & Lifestyle eCommerce Platform with Mobileapp",
        "Carous – Used Car Buy/Sell & Dealership Website",
        "Chat Central – Facebook Chatbot, eCommerce & Social Media Management Tool",
        "City Flicker – Classified Ads Website and Mobile app",
        "Delivery Dart – Bulk Email And SMS Marketing Software",
        "Doctist: Practo clone – Book Doctors, Order Medicine, Diagnostic center",
        "Doctor Cave – Doctor Directory and Appointment Booking Web+App",
        "Doctor Corps- Hospital Management System",
        "DoxHarbor – Multipurpose CRM with 35 Modules",
        "ExtraAcre – Real Estate Portal with Multiple Users with Android App",
        "Food Desk – Restaurant Management Software with Website",
        "Foodinga – Multiple Restaurant Food ordering Website with Customer, Merchant and Driver Android apps",
        "Friendshiply – Social Networking Platform like Facebook",
        "Future Shaadi – Matrimonial Web Portal",
        "FuzeTube – Video Sharing Platform like YouTube",
        "Garagify – Garage Management System",
        "Gift and Ship: Multi-Vendor eCommerce Platform with Android app",
        "Giga Kart: Multi-Vendor eCommerce Platform with Android & iOS app",
        "Gigabrick – Real Estate Portal Website",
        "Grocer Box: Grocery & Vegetable eCommerce Platform with Android app",
        "Grocery Space – Grocery Multi-Store with Customer, Store and Driver apps",
        "Grocery West – Ecommerce for Grocery, Food, Pharmacy with Android Apps",
        "GymCuts – Gym Management System",
        "Happy Jobs – Complete Job Mobile Application",
        "Healthy Web – Hospital Management System",
        "Hello Hiring – Job Portal based on Geolocation",
        "Hey Pharm – Complete Pharmacy Management Software",
        "Hospitalcore – Complete SAAS Hospital management system",
        "Hospiva- Hospital Management System",
        "Hosspital – Hospital Management System",
        "Hostelstead – Hostel/Room Management System",
        "HPL – Dream 11 Clone Fantasy App",
        "HR Logics – HRM, Payroll & Project Management",
        "Inboxer – Bulk Email Marketing SAAS Application",
        "Janoo – Dating Platform like Tinder/Badoo",
        "Jewellery King: Gold, Silver, Diamond, Artificial Jewellery eCommerce Platform with Mobileapp",
        "Jiffy Meet – Video Conference App and Website for Live Class, Meeting, Webinar, Online Training",
        "Joboro: Complete Job Board with Android & iOS",
        "Jobs Heaven – Complete Job Portal",
        "Juqe – Adult Video Platform",
        "Juvola – Business ERP Solution / Product / Shop / Company Management",
        "Lawyerify – Lawyer Case Management System",
        "LeanCRM – Leads and Customers",
        "Letster – Hostel Management System",
        "Library Bee – Library/Book Management System",
        "Libraxo – Library Management System with Website",
        "Loan Counter- NBFC Finance Mortgage Startup sourcing Loans/Credit Cards",
        "Ludo HG – Ludo Tournament Betting",
        "Magic Meds: Medicine Pharmacy eCommerce 1mg Clone",
        "Magzia – Online Magazine Store",
        "Meat Ala: Multi-Vendor eCommerce Platform with Android app",
        "Motion Flix OTT Platform – Live TV & Movie Portal with Android app",
        "News Shelf – News Portal with Android app",
        "Nyqaa: Cosmetic & Beauty Store eCommerce Platform with Mobileapp",
        "Phroma – Pharmacy Management System",
        "Pokoki- SaaS Business & Accounting Software",
        "Posova- Point of Sale, Billing and Stock Manager Application",
        "Pozlo- Best CRM Software",
        "Print Perfect – Online Custom Printing Services eCommerce",
        "Pru – OLX Clone Classified Mobile Application",
        "Quotora – Live Trading, Market Analysis, Portfolio, Watching List, Subscriptions",
        "Qwestions – Questions and answers platform like Quora",
        "Recruitpool:- Complete SAAS Recruitment Manager",
        "Recruitrabbit – SAAS Human Resource Management",
        "Result Wizard – Result Management System",
        "Resumesy – Complete SAAS Resume Builder",
        "Rishtey – Shaadi Clone Matrimony Android & iOS app",
        "Ristly – CRM & Project Manager",
        "SALON – Salon Booking System",
        "Scholarr – Online Learning and Examination System",
        "SchoolNerd – School Management System",
        "Schoolowl – School Management System",
        "SchoolRoster – School Management System",
        "SchoolSector- School Management System",
        "Schoolsilo – School Management System",
        "SecretBus- Bus Reservation System",
        "Skill Buzz – Online Courses and Learning Management System like Udemy",
        "SkillMarks – Ultimate eLearning Website",
        "SupportorBit – Support Ticket Management System",
        "Synira – Live Web Chat & Client Desk & Ticket Help Centre",
        "Textzo – Smart SMS & Email Manager",
        "Tokito – Android & iOS media app for creating and sharing short videos",
        "Tourio – Book Hotels, Tours, Flights, Activities, Cabs – Complete Travel Portal",
        "TrueClient – Customer Relationship And Project Management System",
        "Tunato – AMC and Customer Service Call/Complaint Management Application",
        "Ultreno – SAAS Project Management System",
        "Urban Company – Service Booking Website with mobile app",
        "Viziweb – ISP Management System",
        "WorkYouWant – Freelancer Jobs, Hire Freelancers, Freelancer Clone",
        "Xoti – Visitor Pass Management System",
        "Yellow Leather: Leather Store eCommerce Platform with Android app",
        "YUBR- On Demand Taxi & Cab Booking Android app for Customer & Driver",
        "Zecuna – Web Hosting Billing & Automation Software",
        "Zyial- Salon Booking Management System"
      ],
      technologies: [
    ...
    'software-company-50-crm-cloud-solutions-salesforce-zoho-clone': {
      title: "Software Company with 50+ CRM and Cloud solutions – Salesforce/Zoho Clone",
      category: "Companies",
      tags: ["CRM", "Cloud Solutions", "Salesforce Clone", "Zoho Clone", "Enterprise"],
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "This is an Indian cloud-based software company that provides customer relationship management solutions and also provides enterprise applications focused on customer service, marketing automation, analytics, and application development.",
      features: [
        "Bhity – Inventory Management System with POS, HRM, Accounting",
        "DoxHarbor – Multipurpose CRM with 35 Modules",
        "Garagify – Garage Management System",
        ...
        "Grocery Space – Grocery Multi-Store with Customer, Store and Driver apps",
        "Giga Kart: Multi-Vendor eCommerce Platform with Android & iOS app",
        "Foodinga – Multiple Restaurant Food ordering Website with Customer, Merchant and Driver apps",
        "Business Notion – Complete SAAS Business for Stock Management, POS & Invoicing",
        "Hospitalcore – Complete SAAS Hospital management system",
        "Loan Counter- NBFC Finance Mortgage Startup sourcing Loans/Credit Cards",
        "Print Perfect – Online Custom Printing Services eCommerce",
    ...
    'heytext-bulk-sms-application-for-marketing': {
      title: "HeyText – Bulk SMS Application For Marketing",
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "This is a powerful, flexible, and User-friendly Bulk SMS Marketing Application. It's also an all-in-one solution for your SMS marketing. It's easy to use. If you want to run this application, you have to purchase sms gateway API from sms gateway providers like Twilio, nexmo, plivo, MSG91 etc. There are more than 50+ sms gateway APIs already integrated with system. You can choose one from these or you can also add your gateway. Then you have to update your sms API credentials. Finally, you can send your sms using your sms gateway API through this application.",
      features: [
        "Client Management",
        "Campaign Builder",
        "Send Schedule SMS",
        ...
        "Appearance",
        "Twilio Integration",
        "Twilio Copilot Integration",
        "Clickatel Integration",
        "Route Mobile Integration",
        "easysendsms.com Integration",
        "Plivo Integration",
        "Plivo Powerpack Integration",
        "cheapglobalsms.com Integration",
        ...
        "routee.net Integration",
        "hutch.lk Integration",
        "teletopiasms.no Integration",
        "broadcastermobile.com Integration",
        "solutions4mobiles.com Integration",
        "beem.africa Integration",
        "bulksmsonline.com Integration",
        "flowroute.com Integration",
        "elitbuzz-bd.com Integration",
        "greenweb.com.bd Integration",
        "hablame.co Integration",
        "zamtel.co.zm Integration",
        "cellcast.com.au Integration",
        "africastalking.com Integration",
        "caihcom.com Integration",
        "KeccelSMS Integration",
        "JohnsonConnect Integration",
        "smsala.com Integration",
        "speedamobile.com Integration",
        "text2world.com Integration",
        "enablex.io Integration",
        "spoofsend.com Integration",
        "login.haj-sms.com Integration",
        "SendroidUltimate Integration",
        "realsms.cc Integration",
        "callr.com Integration",
        "skyetel.com Integration",
        "sms.lrt.com.pk Integration",
        "bulksmsplans.com Integration",
        "Sinch Integration",
        "D7Networks Integration",
        "CMCOM Integration",
        "PitchWink Integration",
        "api-messaging.wavy.global Integration",
        "solucoesdigitais.cc Integration",
        "smsmarketing.ae Integration",
        "zipcom.io Integration",
        "GlobalSMSCN Integration",
        "web2sms237.com Integration",
        "BongaTech Integration",
        "floatsms.com Integration",
        "YooAPI Integration",
        "maissms.com.br Integration",
        "easysms.xyz Integration",
        "sozuri.net Integration",
        "experttexting.com Integration",
        "Ejoin Integration",
        "bulksmsnigeria.com Integration",
        "sendsmsgate.com Integration",
        "gateway360.com Integration",
        "ajuratech.com Integration",
        "smscloud.ci Integration",
        "lifetimesms.com Integration"
      ],
      technologies: [
        "PHP",
        "MySQL",
    ...
    'fantica-premium-content-creators-saas-platform-onlyfans-clone': {
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "This is a fully-featured PHP platform that allows you to start your own premium content-based social media platform in no time. The experience is powered by a mobile-first, clean and easy-to-use design, with Dark and Light mode themes, RTL, and localization capabilities. It allows your creators to sell their premium content via monthly subscriptions, offers, bundles, tips, and pay to unlock posts.",
      features: [
        ...
        "Bidirectional feed module with swippable gallery",
        "Full-screen view",
        ...
        "Time-limited user subscriptions offer",
        "Post & User tips",
        "Pay to unlock posts",
        "Ad spots",
        "Free profiles",
    ...
    'mailmill-bulk-email-marketing-software-application': {
      ...
      features: [
        ...
        "No limitations on email sending",
        "Complete control over the system",
        "Get rid of expensive email services",
        "Easy Integration with REST API",
        "REST API for developers",
        "Manage lists, contacts, campaigns",
        "Integrate with other applications",
        "Keep data synchronized",
        "Fresh new design",
        "Campaign performance insights",
        "User engagement reports",
        "Click-to-open ratio tracking",
        "Bounce/feedback rate monitoring",
        "Individual contact response tracking",
        ...
        "Track delivery of every single email",
        "Find out if emails reach subscribers' inbox",
        "Opens/clicks/bounces/complaints recording",
        "Interactive charts & data table visualization",
        "Different types of reports",
        "Valuable information for campaign improvement",
        "Easy Integration with SMTP or 3rd Services",
        "Configure to send from own SMTP server",
        "Get away from expensive email services",
        "Unlimited access to any functionality",
        "Built-in support for 3rd service providers",
        "Amazon SES integration",
        "SendGrid integration",
        "Mailgun integration",
        "ElasticEmail integration",
        "SparkPost integration",
        "Any SMTP service provider support",
        "Fully Featured Automation & Auto-responder",
        "Automatically send email campaigns",
        "Conditionally send based on events",
        "List subscription triggers",
        "List unsubscription triggers",
        "Subscriber's birthday triggers",
        "Custom criteria triggers",
        "Quota exceeding triggers",
        "Balance falling below minimum triggers",
        "Package plan expiration triggers",
        "Follow up when email is opened/clicked",
        "Setup once, automatic sending",
        "Custom Tracking Domain",
        "Advanced delivery option",
        "Rewrite email links with your domain",
        "Complete sender reputation control",
        "Greatly improves email reputation",
        "Better deliverability",
        "Quick & Easy RESTful API",
        "RESTful API based on HTTP POST/GET",
        "Easy integration with websites/applications",
        "Add/import contacts from other applications",
        "Keep mail list synchronized",
        "Up-to-date contact management",
        "Advanced Email Template Builder",
        "Advanced Email Template Builder included",
        "Dozens of pre-built email templates",
        "Pre-built email layouts",
        "Ready-to-use templates",
        "Designed as SaaS Framework",
        "SaaS (Software As A Service) platform",
        "Manage and sell email service to users",
        ...
        "Email Verification",
        "Ensure email list is clean and validated",
        "Reduce bounce back",
        "Protect sending reputation",
        "Verify mail lists with 3rd party services",
        "Kickbox.io integration",
        "TheChecker.co integration",
        "Tag addresses with appropriate status",
        "Deliverable/Undeliverable/Risky status",
        "Send emails only to real users",
        "Fully Responsive Design",
        "Access webapp from any device",
        "PC, tablet or smartphone support",
        "Mobile-optimized interface",
        "Embed Subscription Form",
        "Embed subscription form on your website",
        "Collect subscribers for your campaign",
        "Design and customize sign-up form",
        "Embed on your own website",
        "Your own brand and look-and-feel",
        "Mass Newsletters Sending",
        "Multi-threading support",
        "Send millions of emails everyday",
        "Auto scheduling for email campaigns",
        ...
        "Inspired by Mailchimp",
        "Clean and relevant workflow",
        "User-friendly interface",
        "Enjoy working with campaigns",
        "Multiple Themes Available",
        "Several themes to choose from",
        "Dark/light/red/blue/green/pink/brown themes",
        "Custom themes for every user",
        "Extend standard CSS",
        "Build your own theme & layout",
        "Web Application",
        "Fully responsive web platform",
        "Cross-browser compatibility",
        "Modern web technologies",
      ...
      demoUrl: "https://www.ufglab.com/industries/digital-marketing/mailmill-bulk-email-marketing-software-application",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },
    ...
    'inboxer-bulk-email-marketing-saas-application': {
      ...
      features: [
        ...
        "Become an Email Service Provider for customers",
        "Easy payment gateway integration",
        "Complete tools for pricing plans",
        "Promotional codes management",
        "Order and transaction management",
        "Customer management system",
        "Unlimited Email Campaigns",
        "Send unlimited number of email campaigns",
        "Unlimited newsletter sending",
        "Unlimited email lists support",
        "Unlimited subscribers per list",
        "Mass email distribution",
        "Multi-Website Support",
        "Handle newsletters for multiple websites",
        "Treat websites as customers",
      ...
      demoUrl: "https://www.ufglab.com/industries/digital-marketing/inboxer-bulk-email-marketing-saas-application",
      githubUrl: "https://github.com/ufglab",
      liveUrl: "https://www.ufglab.com"
    },

    'order-vcard-portfolio-vcard-builder-saas-multi-user-profile': {
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "You can use this application to build a multiuser profile website. The business website is Multi-lingual & also RTL supported You can create unlimited monthly / yearly / lifetime packages, control features for that packages. You can make a package Free, Trial, Premium or only free or only trial or only premium. You can set trial days for trial packages. Users can purchase this packages & have a user dashboard to create Multilingual Portfolio Website, unlimited vCards, unlimited CVs for them.",
      features: [
        ...
        "Multilingual Profile Pages",
        "RTL Supported Profile Pages",
        "Package Purchase",
        "Base Color Settings",
        "Preloader, Logo, Favicon Upload",
        "SEO Info Management",
    ...
    'sendnova-bulk-email-sms-and-whatsapp-messaging-application': {
      ...
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center",
      heroImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop&crop=center",
      overview: "The Web Application sends bulk Emails through SMTP, PHP Mailer, Send Grid API, and also sends mass SMS via Android device using SIM and SMS API Gateway. Also, You can send mass WhatsApp(QR/CloudAPI) messaging, SMS and Email as a promotional campaign or others.",
      features: [
        "Send Mass Email",
        "send mass email through supported files CSV, excel, TXT, and also from a group that you can store in your panel",
        "Send Mass SMS",
        "Send SMS to many people at a time supported files CSV, excel, TXT, and also from a group that you can store in your panel",
        "WhatsApp Messaging(Node Js & Meta Cloud API)",
        "Send WhatsApp messages to many people at a time supported files CSV, excel, TXT, and also from a group that you can store in your panel",
        "You can also add multiple WhatsApp accounts in your panel",
        "Android SMS Sending APP",
        "Send SMS through the Android SMS sending app from your country's mobile SIM card for a low SMS cost",
        "Try a downloaded DEMO APP from here",
        "SMS Android Gateway app can reduce your SMS cost and if it runs with a dual SIM, the transferring process will be faster and smoother",
        "Dual SIM Support",
        "Android SMS Sending app support dual SIM at a time, reducing SMS sending time from the queue",
        "SMS API Gateway",
        "Send SMS from 3rd party API which includes 7 SMS API Gateways",
        "Email Sending Method",
        "Send Email using SMTP, PHP Mailer, and SendGrid API",
        "White-Level App",
        "You can customize SMS Gateway Apps Logo, Name, and Package Name for up to 2 apps after purchasing this script, each app need two PNG format image/logo 512×512 and 200×80 dimensions"
      ],
      technologies: [
        "PHP",
        "MySQL",
