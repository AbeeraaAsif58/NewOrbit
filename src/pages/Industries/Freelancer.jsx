    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Personal Brand • Lead Generation • Portfolio
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Build your personal brand, <span className="text-cyan-200">attract dream clients</span> — freelancer success
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          Professional portfolio websites and lead generation systems that showcase your skills and attract high-paying clients.
        </p>

        <div className="mt-7 grid gap-3 sm:max-w-2xl sm:grid-cols-[1fr_auto]">
          <div className="relative">
            <input
              placeholder="Search: portfolio design, personal branding, client acquisition…"
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "500+", l: "Freelancers Helped" },
            { k: "95%", l: "Client Acquisition" },
            { k: "3x", l: "Rate Increase" },
            { k: "24/7", l: "Portfolio Support" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["WordPress", "Squarespace", "Webflow", "Figma", "Canva", "LinkedIn"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "Stunning portfolio websites that showcase your work and attract high-quality clients.",
      tech: ["Portfolio Design", "Responsive", "SEO Optimized"],
    },
    {
      tag: "New",
      title: "Personal Branding Package",
      desc: "Complete personal branding including logo, business cards, and social media templates.",
      tech: ["Brand Identity", "Logo Design", "Social Media"],
    },
    {
      tag: "Popular",
      title: "Lead Generation System",
      desc: "Automated lead generation and client acquisition systems for consistent business growth.",
      tech: ["Lead Magnets", "Email Marketing", "Automation"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        "Modern portfolio website for a graphic designer with client testimonials and project gallery.",
        "Developer showcase site highlighting technical skills and open-source contributions.",
        "Professional blog and portfolio for a freelance writer with published articles and testimonials.",
        "Stunning photography portfolio with high-resolution galleries and client booking system.",
        "Business consultant website with case studies, services, and client success stories.",
        "Life coach website with booking system, testimonials, and resource library.",
        "Digital artist portfolio showcasing creative work and commission information.",
        "Marketing consultant hub with lead magnets, case studies, and service offerings.",
        "Management consultant site with expertise areas, client testimonials, and contact forms.",
      ][i],
  }));
  ...
  return (
    <section id="projects" className="mt-12" data-reveal>
      <div className="mb-4 flex items-end justify-between">
        <h2 className="text-xl font-semibold sm:text-2xl">Portfolio examples</h2>
        <span className="text-sm text-white/60">{cards.length} examples</span>
      </div>
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "My new portfolio helped me{" "}
          <span className="text-cyan-200">triple my rates</span> and attract premium clients. The investment paid for itself in the first month."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— Sarah M., Freelance Designer</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to elevate your freelance business?</h3>
          <p className="mt-2 max-w-xl text-white/80">
            Let's create a professional presence that attracts your ideal clients and grows your freelance business.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Portfolio Preview</div>
          </div>
