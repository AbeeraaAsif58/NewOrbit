...
export default function HumanResource() {
  return (
    <OptimizedIndustryPage
      ...
      description="Professional human resource services and solutions. Discover our verified and tested HR projects ready for deployment."
      projects={projects}
      basePath="/human-resource"
    />
  );
}