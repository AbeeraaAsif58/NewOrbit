    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        ...
        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          From strategy to execution, we create memorable brand experiences that connect with audiences and drive business growth.
        </p>
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "600+", l: "Campaigns Launched" },
            { k: "99%", l: "Client Retention" },
            { k: "25+", l: "Industry Awards" },
            { k: "24/7", l: "Creative Support" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["Adobe Creative Suite", "Figma", "Sketch", "Principle", "After Effects", "Cinema 4D"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "Complete brand strategy, positioning, and visual identity that resonates with your target audience.",
      tech: ["Brand Strategy", "Visual Identity", "Positioning"],
    },
    {
      tag: "New",
      title: "Digital Experience Design",
      desc: "End-to-end digital experiences that engage users and drive conversions across all touchpoints.",
      tech: ["UX/UI Design", "Digital Strategy", "User Research"],
    },
    {
      tag: "Popular",
      title: "Creative Campaign Development",
      desc: "Multi-channel creative campaigns that build brand awareness and drive measurable results.",
      tech: ["Campaign Strategy", "Creative Direction", "Multi-Channel"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        "Complete brand strategy and visual identity for a disruptive fintech startup.",
        "Luxury fashion brand campaign with high-end photography and creative direction.",
        ...
        "Professional rebrand for a financial services firm targeting millennials.",
        "Vibrant campaign for a craft beverage brand with authentic storytelling.",
        "Inspiring brand identity for a social impact organization.",
        "Modern corporate website redesign that maintains heritage while embracing innovation.",
        "Dynamic brand launch for an entertainment company with bold creative direction.",
      ][i],
  }));
