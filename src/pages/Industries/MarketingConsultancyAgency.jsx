    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Strategic Advisory • Marketing Audits • GTM Frameworks
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Strategic marketing guidance, <span className="text-cyan-200">accelerate growth</span> — consultancy excellence
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          Expert marketing consultancy and strategic advisory services that drive measurable business growth and market expansion.
        </p>

        <div className="mt-7 grid gap-3 sm:max-w-2xl sm:grid-cols-[1fr_auto]">
          <div className="relative">
            <input
              placeholder="Search: marketing strategy, GTM planning, market analysis…"
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "200+", l: "Companies Advised" },
            { k: "98%", l: "Client Satisfaction" },
            { k: "4x", l: "Growth Acceleration" },
            { k: "24/7", l: "Strategic Support" },
          ].map((it, i) => (
            <div
              key={i}
              data-reveal
...
function TrustMarquee() {
  const logos = ["HubSpot", "Salesforce", "Google Analytics", "Adobe", "Mailchimp", "LinkedIn"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "Comprehensive analysis of your current marketing efforts with actionable recommendations for improvement.",
      tech: ["Strategy Audit", "Competitive Analysis", "ROI Optimization"],
    },
    {
      tag: "New",
      title: "Go-to-Market Planning",
      desc: "Complete GTM strategy development for new products and market entry initiatives.",
      tech: ["GTM Strategy", "Market Research", "Launch Planning"],
    },
    {
      tag: "Popular",
      title: "Growth Acceleration",
      desc: "Strategic guidance to accelerate business growth through optimized marketing and sales alignment.",
      tech: ["Growth Strategy", "Sales Alignment", "Performance Optimization"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        "Developed comprehensive GTM strategy for SaaS startup that achieved 300% growth in first year.",
        "Optimized e-commerce marketing strategy resulting in 250% increase in online sales and customer acquisition.",
        "Implemented B2B lead generation system that increased qualified leads by 400% and improved conversion rates.",
        "Created healthcare marketing strategy that improved patient engagement by 200% and brand awareness.",
        "Launched fintech product with strategic marketing approach that secured $10M in funding and 50K users.",
        "Expanded edtech platform to new markets with localized marketing strategies and 150% user growth.",
        "Digital transformation for manufacturing company with modern marketing approach and 180% lead increase.",
        "Developed omnichannel retail strategy that improved customer experience and increased sales by 120%.",
        "Growth strategy for non-profit organization that increased donations by 300% and volunteer engagement.",
      ][i],
  }));
  ...
  return (
    <section id="projects" className="mt-12" data-reveal>
      <div className="mb-4 flex items-end justify-between">
        ...
        <span className="text-sm text-white/60">{cards.length} case studies</span>
      </div>
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "The strategic guidance helped us{" "}
          <span className="text-cyan-200">4x our revenue</span> in just 18 months. The marketing expertise was game-changing."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— CEO, GrowthTech Inc.</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to accelerate your growth?</h3>
          <p className="mt-2 max-w-xl text-white/80">
            Let's develop a strategic marketing approach that drives measurable results and sustainable business growth.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Strategy Dashboard</div>
          </div>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-5 transition hover:-translate-y-1.5 hover:border-cyan-200/50">
      <div className="aspect-video w-full overflow-hidden rounded-xl border border-white/10 bg-white/5">
        <div className="flex h-full items-center justify-center text-white/40">Strategy Results</div>
      </div>
      <h3 className="mt-3 text-lg font-semibold transition-colors group-hover:text-cyan-200">{title}</h3>
