    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-orange-400/80">
          <Dot /> Enterprise Solutions • Digital Transformation • Integration
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Transform enterprise operations, <span className="text-orange-400">drive digital innovation</span> — corporate solutions
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          Comprehensive digital solutions for large enterprises, from web portals to system integrations and digital transformation.
        </p>

        <div className="mt-7 grid gap-3 sm:max-w-2xl sm:grid-cols-[1fr_auto]">
          <div className="relative">
            <input
              placeholder="Search: enterprise portals, system integration, digital transformation…"
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "200+", l: "Enterprise Clients" },
            { k: "99.9%", l: "Uptime SLA" },
            { k: "50%", l: "Efficiency Gain" },
...
function TrustMarquee() {
  const logos = ["Microsoft", "Salesforce", "SAP", "Oracle", "IBM", "AWS"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "Custom enterprise portals that streamline operations and improve employee productivity.",
      tech: ["Portal Development", "User Management", "Integration"],
    },
    {
      tag: "New",
      title: "System Integration Services",
      desc: "Seamless integration of existing systems with new technologies for improved efficiency.",
      tech: ["API Integration", "Data Migration", "Legacy Systems"],
    },
    {
      tag: "Popular",
      title: "Digital Transformation",
      desc: "Comprehensive digital transformation strategies that modernize enterprise operations.",
      tech: ["Digital Strategy", "Process Automation", "Cloud Migration"],
    },
  ];
  return (
...
function ProjectsGrid() {
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        "Comprehensive employee portal for Fortune 500 company with 50,000+ users and complex workflows.",
        "Integrated healthcare management system connecting multiple hospitals and clinics nationwide.",
        "Secure financial services platform handling millions of transactions with compliance requirements.",
        "Manufacturing ERP integration streamlining production and supply chain management.",
        "Government portal redesign improving citizen services and digital accessibility.",
        "Retail chain management system connecting 500+ stores with centralized inventory and reporting.",
        "Energy sector dashboard providing real-time monitoring and analytics for power generation.",
        "Educational platform serving 100,000+ students with online learning and assessment tools.",
        "Logistics management system optimizing shipping and delivery operations across multiple regions.",
      ][i],
  }));
  ...
  return (
    <section id="projects" className="mt-12" data-reveal>
      <div className="mb-4 flex items-end justify-between">
        <h2 className="text-xl font-semibold sm:text-2xl">Enterprise solutions</h2>
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "The enterprise solution they delivered improved our operational efficiency by{" "}
          <span className="text-orange-400">60%</span> and reduced costs by 40%. Exceptional work."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— CTO, GlobalCorp</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to transform your enterprise?</h3>
          <p className="mt-2 max-w-xl text-white/80">
            Let's discuss how we can help modernize your enterprise operations with cutting-edge digital solutions.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Enterprise Dashboard</div>
          </div>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-5 transition hover:-translate-y-1.5 hover:border-cyan-200/50">
      <div className="aspect-video w-full overflow-hidden rounded-xl border border-white/10 bg-white/5">
        <div className="flex h-full items-center justify-center text-white/40">Enterprise Solution</div>
      </div>
      <h3 className="mt-3 text-lg font-semibold transition-colors group-hover:text-orange-400">{title}</h3>
