...
export default function Travel() {
  return (
    <OptimizedIndustryPage
      ...
      description="Explore our travel and tourism solutions that help businesses manage bookings, itineraries, and customer experiences in the hospitality industry."
      projects={projects}
      basePath="/travel"
    />
  );
