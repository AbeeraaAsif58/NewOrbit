    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Web Development • UI/UX • Integration
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Transform Your Business with <span className="text-cyan-200">Cutting-Edge Web Solutions</span>
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          We develop bespoke web applications focused on your target audience's needs. Own your code and add new features as necessary with our innovative approach.
        </p>
...
function TrustMarquee() {
  const logos = ["Custom Development", "Web Applications", "UI/UX Design", "API Integration", "Data Management", "Process Automation"];
  return (
  ...
  const cards = [
    {
      ...
      desc: "Develop bespoke web solutions tailored to your target audience's needs. Own the code and add new features as necessary.",
      tech: ["Custom Development", "Web Apps", "Full-Stack"],
    },
    {
      tag: "New",
  ...
  const cards = Array.from({ length: 9 }).map((_, i) => ({
    ...
    desc:
      [
        ...
        "Next-generation financial services web application with mortgage and investment features.",
        "Gaming community platform where developers and gamers transact in-game assets.",
        "Secure financial tools web portal with cybersecurity and compliance features.",
        "Modern banking web interface with lending, borrowing, and investment services.",
        "Blockchain solution web platform for innovative financial technology applications.",
        "Data-driven analytics web application with advanced visualizations and reporting.",
        "Third-party service integration and API development for financial platforms.",
        "Automated business process web solutions for financial operations and compliance.",
      ][i],
  }));
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          "UFG LAB delivered a web solution that not only looks amazing but also{" "}
          <span className="text-cyan-200">performs exceptionally well</span>. Our conversion rates increased by 200% and user engagement tripled."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— CTO, Financial Services Inc.</div>
      </div>
    </section>
  );
}
      ...
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          ...
          <p className="mt-2 max-w-xl text-white/80">
            Let's work together to bring your vision to life. Our team of experts is ready to help you create something extraordinary with cutting-edge web solutions.
          </p>
        ...
        <div className="relative isolate">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            <div className="flex h-full items-center justify-center text-white/40">Website Preview</div>
          </div>
