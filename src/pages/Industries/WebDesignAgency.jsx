...
const projects = [
  ...
  },
  {
    ...
    description: "Beautiful restaurant website with online menu, reservations, and location integration",
    status: "Available",
    price: "$1,500 – $2,500",
  ...
  },
  {
    ...
    category: "Web Design",
    tags: ["Mobile", "Landing"],
    description: "High-converting landing page for mobile app with download links and feature showcase",
    status: "Available",
    price: "$1,000 – $1,800",
...
export default function WebDesignAgency() {
  return (
    <OptimizedIndustryPage
      title="Web Design Agency Solutions"
      description="Professional web design services for modern businesses. From corporate websites to e-commerce platforms, we create stunning digital experiences that drive results."
      projects={projects}
      basePath="/web-design-agency"
    />
  );
}