    ...
    <section id="hero" data-reveal className="relative isolate py-4 sm:py-8">
      <div className="max-w-5xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] text-cyan-200/80">
          <Dot /> Personal Branding • Portfolio Design • Content Creation
        </span>

        <h1 className="mt-4 text-4xl sm:text-6xl lg:text-7xl font-semibold leading-[1.08] tracking-tight">
          Showcase your expertise, <span className="text-cyan-200">build your personal brand</span> — portfolio excellence
        </h1>

        <p className="mt-5 text-lg sm:text-xl lg:text-2xl text-white/85">
          Professional portfolio websites and personal branding solutions that highlight your skills and attract opportunities.
        </p>

        <div className="mt-7 grid gap-3 sm:max-w-2xl sm:grid-cols-[1fr_auto]">
          <div className="relative">
            <input
              placeholder="Search: portfolio design, personal branding, content creation…"
        ...
        <div className="mt-9 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { k: "1000+", l: "Portfolios Created" },
            { k: "98%", l: "Client Satisfaction" },
            { k: "5x", l: "Opportunity Increase" },
  ...
  const cards = [
    {
      ...
      desc: "Stunning portfolio websites that showcase your work and attract career opportunities.",
      tech: ["Portfolio Design", "Responsive", "SEO Optimized"],
    },
    {
      tag: "New",
      title: "Personal Branding",
      desc: "Complete personal branding package including logo, business cards, and social media presence.",
      tech: ["Brand Identity", "Logo Design", "Social Media"],
    },
    {
      tag: "Popular",
      title: "Content Hub",
      desc: "Blog and content management systems that establish thought leadership and expertise.",
      tech: ["Blog Design", "CMS", "Content Strategy"],
    },
  ];
  return (
    ...
    <section className="mt-12" data-reveal>
      <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-10 text-center shadow-[0_0_50px_-25px_rgba(255,255,255,.35)]">
        <blockquote className="mx-auto max-w-3xl text-lg text-white/90">
          ...
          <span className="text-cyan-200">land my dream job</span> and increased my freelance opportunities by 300%. Absolutely worth it."
        </blockquote>
        <div className="mt-3 text-sm text-white/60">— Alex K., UX Designer</div>
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div className="grid items-center gap-6 sm:grid-cols-[1.2fr_.8fr]">
        <div>
          <h3 className="text-2xl font-semibold">Ready to build your personal brand?</h3>
          <p className="mt-2 max-w-xl text-white/80">
            Let's create a professional portfolio that showcases your expertise and opens doors to new opportunities.
          </p>
